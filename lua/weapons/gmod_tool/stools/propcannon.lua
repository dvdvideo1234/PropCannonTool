...
elseif(CLIENT) then
  ...
  list.Add("CannonModels","models/props_junk/TrashBin01a.mdl")

  table.Empty(list.GetForEdit("CannonAmmoModels"))
  list.Add("CannonAmmoModels","models/props_c17/canister01a.mdl")
  list.Add("CannonAmmoModels","models/props_c17/canister_propane01a.mdl")
  list.Add("CannonAmmoModels","models/props_c17/column02a.mdl")
  list.Add("CannonAmmoModels","models/props_c17/gravestone_cross001a.mdl")
  list.Add("CannonAmmoModels","models/props_c17/gravestone_cross001b.mdl")
  list.Add("CannonAmmoModels","models/props_c17/oildrum001.mdl")
  list.Add("CannonAmmoModels","models/props_c17/oildrum001_explosive.mdl")
  ...
  list.Add("CannonAmmoModels","models/props_junk/TrafficCone001a.mdl")
  ...
  list.Add("CannonAmmoModels","models/props_trainstation/trainstation_ornament001.mdl")
  list.Add("CannonAmmoModels","models/props_trainstation/trainstation_ornament002.mdl")
  list.Add("CannonAmmoModels","models/props_wasteland/buoy01.mdl")

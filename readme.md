...
### Description
The non-working ported prop cannon tool that that I fixed and ported to GM13. The original
...
### How to use
Just weld it to a prop or spawn it on the map. When `Auto fire toggle` is active the cannon will
